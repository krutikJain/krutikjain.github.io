...
this.wp = this.wp || {}, this.wp.apiFetch = function(e) {
    ...
    jqrR: function(e, r, t) {
        ...
        var u = function(e) {
            function r(e, t) {
                var n = e.headers,
                    o = void 0 === n ? {} : n;
                for (var c in o)
                    if ("x-wp-nonce" === c.toLowerCase() && o[c] === r.nonce) return t(e);
                return t(a(a({}, e), {}, {
                    headers: a(a({}, o), {}, {
                        "X-WP-Nonce": r.nonce
                    })
        ...
        var f = function(e, r) {
            var t, n, o = e.path;
            return "string" == typeof e.namespace && "string" == typeof e.endpoint && (t = e.namespace.replace(/^\/|\/$/g, ""), o = (n = e.endpoint.replace(/^\//, "")) ? t + "/" + n : t), delete e.namespace, delete e.endpoint, r(p(p({}, e), {}, {
                path: o
            }))
        };
        ...
        var b = function(e) {
            return function(r, t) {
                return f(r, (function(r) {
                    var n, o = r.url,
                        c = r.path;
                    return "string" == typeof c && (n = e, -1 !== e.indexOf("?") && (c = c.replace("?", "&")), c = c.replace(/^\//, ""), "string" == typeof n && -1 !== n.indexOf("?") && (c = c.replace("?", "&")), o = n + c), t(O(O({}, r), {}, {
                        url: o
                    }))
                }))
            }
        ...
        var j = function(e) {
                var r = Object.keys(e).reduce((function(r, t) {
                    return r[d(t)] = e[t], r
                }), {});
                return function(e, t) {
                    var n = e.parse,
                    ...
                    if ("string" == typeof e.path) {
                        ...
                        if ("GET" === c && r[i]) {
                            var a = r[i];
                            return delete r[i], Promise.resolve(o ? a.body : new window.Response(JSON.stringify(a.body), {
                                status: 200,
                                statusText: "OK",
                                headers: a.headers
                            }))
                        }
                        if ("OPTIONS" === c && r[c] && r[c][i]) return Promise.resolve(r[c][i])
                    }
                    return t(e)
                }
            },
        ...
        var m = function(e) {
            ...
            S = function() {
                var e = Object(v.a)(h.a.mark((function e(r, t) {
                    var n, c, i, a, u, s;
                    return h.a.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            ...
                            case 2:
                                ...
                                return e.abrupt("return", t(r));
                            case 4:
                                return e.next = 6, B(P(P({}, (f = {
                                    per_page: 100
                                }, l = void 0, O = void 0, l = (p = r).path, O = p.url, P(P({}, Object(o.a)(p, ["path", "url"])), {}, {
        ...
        var T = function(e) {
                ...
                return r ? 204 === e.status ? null : e.json ? e.json() : Promise.reject(e) : e
            },
            M = function(e) {
                var r = {
                    code: "invalid_json",
            ...
            A = function(e) {
                var r = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
                return Promise.resolve(T(e, r)).catch((function(e) {
                    return R(e, r)
                }))
            };
        ...
        var Q = function(e, r) {
            if (!(e.path && -1 !== e.path.indexOf("/wp/v2/media") || e.url && -1 !== e.url.indexOf("/wp/v2/media"))) return r(e, r);
            var t = 0;
            return r(N(N({}, e), {}, {
                parse: !1
            })).catch((function(n) {
        ...
        var G = function(e) {
            ...
            I = function(e) {
                var r = e.url,
                    ...
                    s = e.body,
                    p = e.headers;
                return p = H(H({}, F), p), n && (s = JSON.stringify(n), p["Content-Type"] = "application/json"), window.fetch(r || t, H(H(H({}, L), u), {}, {
                    body: s,
                    headers: p
                })).then((function(e) {
                    return Promise.resolve(e).then(G).catch((function(e) {
                        return R(e, a)
                    })).then((function(e) {
                        return A(e, a)
                    }))
        ...
        function J(e) {
            ...
            }), I)(e).catch((function(r) {
                return "rest_cookie_invalid_nonce" !== r.code ? Promise.reject(r) : window.fetch(J.nonceEndpoint).then(G).then((function(e) {
                    return e.text()
                })).then((function(r) {
                    return J.nonceMiddleware.nonce = r, J(e)
                }))
            }))
        }
        J.use = function(e) {
            ...
            I = e
        }, J.createNonceMiddleware = u, J.createPreloadingMiddleware = j, J.createRootURLMiddleware = b, J.fetchAllMiddleware = S, J.mediaUploadMiddleware = Q;
        var B = r.default = J
    },
    l3Sj: function(e, r) {
